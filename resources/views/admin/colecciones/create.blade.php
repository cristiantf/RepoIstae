...
<div class="mb-4">
    ...
    <h2 class="fw-bold mb-0 text-primary-custom">Nueva Colección</h2>
</div>
        ...
        <form action="{{ route('admin.colecciones.store') }}" method="POST">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-12">
                    ...
                    <textarea class="form-control form-control-custom @error('descripcion') is-invalid @enderror" id="descripcion" name="descripcion" rows="3">{{ old('descripcion') }}</textarea>
            ...
            <div class="d-flex justify-content-end gap-2">
                ...
                <button type="submit" class="btn btn-primary-custom">
                    <i class="bi bi-save me-1"></i> Guardar Colección
                </button>
            </div>
        </form>
    </div>
