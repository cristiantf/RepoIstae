...
<div class="mb-4">
    ...
    <h2 class="fw-bold mb-0 text-primary-custom">Editar Comunidad</h2>
</div>

<div class="card-custom">
    <div class="card-body p-4">
        <form action="{{ route('admin.comunidades.update', $comunidade->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="row g-4">
                <div class="col-md-8">
                    ...
                    <input type="text" class="form-control form-control-custom @error('nombre') is-invalid @enderror" id="nombre" name="nombre" value="{{ old('nombre', $comunidade->nombre) }}" required>
                    @error('nombre') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                
                <div class="col-md-4">
                    <label for="orden" class="form-label fw-medium">Orden de visualización <span class="text-danger">*</span></label>
                    <input type="number" class="form-control form-control-custom @error('orden') is-invalid @enderror" id="orden" name="orden" value="{{ old('orden', $comunidade->orden) }}" required min="0">
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control form-control-custom @error('descripcion') is-invalid @enderror" id="descripcion" name="descripcion" rows="4">{{ old('descripcion', $comunidade->descripcion) }}</textarea>
            ...
            <div class="d-flex justify-content-end gap-2">
                ...
                <button type="submit" class="btn btn-primary-custom">
                    <i class="bi bi-save me-1"></i> Actualizar Comunidad
                </button>
            </div>
        </form>
    </div>
