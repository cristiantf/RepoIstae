        ...
        <form action="{{ route('documentos.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-4 mb-5">
                ...
                <div class="col-12">
                    ...
                    <input type="text" class="form-control form-control-custom @error('palabras_clave') is-invalid @enderror" id="palabras_clave" name="palabras_clave" placeholder="Ej: desarrollo web, repositorio, dspace" value="{{ old('palabras_clave') }}">
